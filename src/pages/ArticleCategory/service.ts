...
import {
  article_category_delete_url,
  article_category_list_url,
  article_category_update_url, article_category_create_url,
...
export async function createRecord(params: any) {
  return request.post(article_category_create_url,{data:{...params}});
}
